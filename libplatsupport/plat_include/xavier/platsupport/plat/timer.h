...
#define NV_TMR_PATH "/timer@3010000"
#define NV_TMR_ID TMR1
#define NV_TMR_ID_OFFSET TMR1_OFFSET

/* See Xavier TRM, chapter 8.4.4.2 */
...
static_assert(sizeof(struct tmr_shared_map) == 0x248, "struct tmr_shared_map has incorrect layout");
